...
/* wuyu@EXP.BaseDrv.LCM, 2015-05-18, add micro OPPO_15011, (OPPO15011=OPPO_15018) */
	if(MSM_BOOT_MODE__NORMAL!=get_boot_mode() && (is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022) || is_project(OPPO_15035) || is_project(OPPO_15029) || is_project(OPPO_15109))){
		pinfo->esd_check_enabled = false;
	}
