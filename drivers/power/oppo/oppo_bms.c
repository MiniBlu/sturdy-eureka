...
int opchg_get_prop_batt_capacity(struct opchg_charger *chip)
{
	...
	if(is_project(OPPO_14043) || is_project(OPPO_14037) || is_project(OPPO_14051) ||
		...
		is_project(OPPO_15035) || is_project(OPPO_15109)){
...
int opchg_get_prop_current_now(struct opchg_charger *chip)
{
	...
	else if(is_project(OPPO_14037) || is_project(OPPO_14051) || is_project(OPPO_15057) || is_project(OPPO_15009) || is_project(OPPO_15037)) {
		if(!chip->chg_present){
			chg_current = 0;
		} else {
