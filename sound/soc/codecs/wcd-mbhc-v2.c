...
static void wcd_correct_swch_plug(struct work_struct *work)
{
    ...
    if (is_project(OPPO_15009) || is_project(OPPO_15037) || is_project(OPPO_15011) || is_project(OPPO_15018)) {
        #ifdef VENDOR_EDIT
        //John.Xu@PhoneSw.AudioDriver, 2015/06/11, Add for Qcom patch for slow insert headset
            if (mbhc->btn_press_intr) {
                wcd_cancel_btn_work(mbhc);
...
/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
			if ((hph_count == 6) && ((is_project(OPPO_15011)) || (is_project(OPPO_15009)) || (is_project(OPPO_15018)) || (is_project(OPPO_15037)) || (is_project(OPPO_15022))))
			{
